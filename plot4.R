...
barplot(data1$Global_active.power, ylab = "Global Active Power",col= "white")
...
barplot(data1$Voltage, xlab = "datatime", ylab = "Voltage", col = "white", border = "black", ylim = c(234,246), xpd = TRUE)
barplot(data1$Global_reactive.power, xlab = "datatime", ylab = "Global_reactive.power", col = "white")
dev.off()
